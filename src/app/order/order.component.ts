  ...
  updateQty(){
    this.api.getOrders().subscribe((result)=>{
      ...
      for(let i=0;i<result.length;i++){
        ...
        console.log(this.b,"HGFDSGHJK")
        // this.api.getProductId(result[i].productid).subscribe((res)=>{
         ...
         for(let i=0;i<res.length;i++){
          ...
          // this.api.getProductId(this.pid).subscribe((result3)=>{
          //   this.a=result3[0].quantity;
          // console.log(this.a,'ASDFGHJK')
          //   this.pcat=result3.category;
          // this.pname=result3.productName;
          // this.pdis=result3.description;
          // this.ppris=result3.price;
          // this.pimg=result3.image ;
          // this.qut=result3.quantity;
          ...
          console.log(resultqut,'hgfdsfghj')
          console.log(this.pname+this.pdis+this.ppris,"khjhgfdsadfghjkljhgfdsa")
          this.api.putProductqty(result[i].productid,this.productForm.value).subscribe((res1)=>{
            console.log(res1,"ghfdsfghjk555551")
            alert("Stock updated")
          })
        })
